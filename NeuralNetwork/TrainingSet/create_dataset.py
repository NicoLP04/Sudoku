...
fonts = [
    ...
    # ""https://github.com/googlefonts/rubik/tree/main/old/version-2/fonts/ttf/Rubik-Black.ttf",  # 23
    # ""https://github.com/googlefonts/rubik/tree/main/old/version-2/fonts/ttf/Rubik-Bold.ttf",  # 22
    # ""https://github.com/googlefonts/rubik/tree/main/old/version-2/fonts/ttf/Rubik-Light.ttf",  # 20
    # ""https://github.com/googlefonts/rubik/tree/main/old/version-2/fonts/ttf/Rubik-Medium.ttf",  # 19
    # ""https://github.com/googlefonts/rubik/tree/main/old/version-2/fonts/ttf/Rubik-Regular.ttf",  # 18
    ...
    #"https://github.com/google/fonts/blob/main/ofl/andika/Andika-Bold.ttf?raw=true",  # 1
    #"https://github.com/google/fonts/blob/main/ofl/baskervville/Baskervville-Regular.ttf",  # 1
]
        ...
        with webfont(fonturl + "?raw=true") as f:
            ...
            for digit in range(0, 10):
                ...
                if digit != 0:
                    ...
                    draw.text((14, 14), str(digit), anchor='mm', font=font, fill=0)

                inverted = ImageOps.invert(img)
                inverted.save('LearningSet/' + str(digit) +
